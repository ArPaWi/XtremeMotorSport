"use client"
import styles from "./Sk2.module.css";
...
const Sk2 = () => {
  ...
  const chartInstance = useRef<Chart<"doughnut", number[], string> | null>(null); // Menambahkan tipe referensi untuk instance chart

  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/sk2');
